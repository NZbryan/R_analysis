...
cvfit_cox4 = cv.glmnet(x, y, family = "cox",alpha=0.05,nlambda = 150,standardize = F,parallel=TRUE)
stopImplicitCluster()
...
## train the model
fit_cox = glmnet(x,y, family="cox",alpha=0.05,lambda = cvfit_cox4$lambda.min ,standardize = F)
