...
# png_f = paste("D:/R_workspace/survival/PPT/cv_0005/",i,".png",sep = "")
...
## train the model
fit_cox = glmnet(train_x, train_y, family="cox",alpha=0.15,lambda = cvfit_cox$lambda.min,standardize = F)
...
# 
# #write.csv(chosen_features,"D:/R_workspace/survival/PPT/chosen_features_121.csv")
# 
# chosed_p_hr = pvalue_hr[chosen_names,]
...
# write.csv(chosed_p_hr_beta,"D:/R_workspace/survival/PPT/PPT/chosed_p_hr_beta_scale_new.csv")
# 
